...
const Login = () => {
	const identifierDetails = useValidate({ isRequired: true });
	const passwordDetails = useValidate({ isRequired: true });
	...
	const handleSubmit = (e) => {
		...
		if (identifierDetails.value.trim() === "" || identifierDetails.errorMessage) {
			if (!identifierDetails.errorMessage.length > 0)
				identifierDetails.setErrorMessage("This field is required");
			return;
		}
